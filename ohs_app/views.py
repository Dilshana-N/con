...
# create dashboard function for admin
...
# create dashboard function for worker
...
def appoinmentview_worker(request):
    a = take_appoinments.objects.filter(status=1)
    return render(request, "worker/viewappointment_worker.html", {"a": a})
